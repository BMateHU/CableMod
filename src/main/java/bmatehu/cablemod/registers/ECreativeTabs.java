...
public class ECreativeTabs {
    ...
    public static final DeferredRegister<CreativeModeTab> REGISTER = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CableMod.MODID);



    // Creates a creative tab with the id "examplemod:example_tab" for the example item, that is placed after the combat tab
    public static final RegistryObject<CreativeModeTab> CABLE_MOD_TAB = REGISTER.register("cable_mod", () -> CreativeModeTab.builder()
